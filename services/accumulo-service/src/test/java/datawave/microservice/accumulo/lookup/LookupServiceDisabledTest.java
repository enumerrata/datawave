...
import datawave.microservice.accumulo.config.AccumuloConfiguration;
...
public class LookupServiceDisabledTest {
    ...
    /**
     * This config is here only to prevent {@link AccumuloConfiguration} from detecting a "missing" connector bean, which would trigger initialization of a real
     * accumulo connection using our test application.yml's props, which would cause this test to fail
     */
    @Configuration
